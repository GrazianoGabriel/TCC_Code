...
#define MY_DEFAULT_IP_ADDR_BYTE3        (1ul)		//tplink
#define MY_DEFAULT_IP_ADDR_BYTE4        (105ul)     //tplink
//#define MY_DEFAULT_IP_ADDR_BYTE3        (0ul)		//dlink
//#define MY_DEFAULT_IP_ADDR_BYTE4        (130ul)     //dlink
#elif defined(PLACA2)
#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (1ul)		//tplink
#define MY_DEFAULT_IP_ADDR_BYTE4        (106ul)   //tplink
//#define MY_DEFAULT_IP_ADDR_BYTE3        (0ul)		//dlink
//#define MY_DEFAULT_IP_ADDR_BYTE4        (131ul)     //dlink
#endif
